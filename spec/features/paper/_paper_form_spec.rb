...
shared_examples 'a paper form' do
  ...
  context 'should show validation errors' do
    ...
    example 'when the title is empty' do
      fill_in 'Title', with: ''
    ...
    example 'when the venue is empty' do
      fill_in 'Venue', with: ''
      find('input[type=submit]').click
    ...
    example 'when the year is empty' do
      fill_in 'Year', with: ''
      find('input[type=submit]').click
    ...
    example 'when the year is negative' do
      fill_in 'Year', with: '-2017'
      find('input[type=submit]').click
    ...
    example 'when the year is not an integer' do
